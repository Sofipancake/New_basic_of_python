...
формата <Имя класса>: приступил к отрисовке объекта "<title>", при этом для класса Pencil при запуске метода draw в
stdout сначала выводить сообщение Запуск отрисовки, а потом своё уникальное по формату;
